        ...
        return (
            <Deck ref="deck" transition={['zoom', 'slide']} transitionDuration={500} theme={theme}>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <List>
                        <ListItem>
                            Es un proyecto <S type="bold">open source</S> para <S type="bold">empaquetar</S>,
                            <S type="bold">transportar</S> y <S type="bold">ejecutar</S> cualquier <S type="bold">aplicación</S>
                            como un
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={6} textColor="secondary" caps>¿Que son los Contenedores? ¿Eso como se come?</Heading>

                    <Text>Un contenedor conforma el contexto de ejecución de una
                        aplicación. Está compuesto basicamente de:</Text>
                    <List>
                        <ListItem>
                            Sistema de archivos
                        </ListItem>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={6} textColor="secondary" caps>Maquinas virtuales</Heading>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={6} textColor="secondary" caps>¿Y qué diferencia a Docker respecto a una máquina
                        virtual?</Heading>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={6} textColor="secondary" caps>¿Quien puede usar Docker?</Heading>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={6} textColor="secondary" caps>¿Porque usaria Docker si actualmente instalo mis
                        servidores manualmente y todo me va de maravilla? </Heading>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Appear>
                        <Text textSize={32}>Tendrias que instalar y configurar tu propia computadora: problemas de
                            versiones, no existe el componente para tu sistema operativo, etc. </Text>
                    </Appear>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Appear>
                        <Text textSize={32}>Tendrias que buscar las versiones correctas, talvez hasta formatear tu
                            computadora o trabajar en una maquina virtual. </Text>
                    </Appear>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Appear>
                        <Text textSize={32}>Tendrias que ponerle a leer tutoriales y talvez hacer modificaciones a tu
                            proyecto. </Text>
                    </Appear>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={4} textColor="secondary" caps>¿Aún no te convences? </Heading>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    <div className="animated pulse infinite">
                        <Heading size={4} textColor="secondary" caps>Mucha charla y poca acción</Heading>
                    </div>
                ...
                <Slide transition={['fade']} bgImage={image} bgColor="primary">
                    ...
                    <Heading size={6} textColor="secondary" caps>Posibles inquitudes</Heading>
